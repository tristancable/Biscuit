...
namespace DigitRecognizer.Services
{
    ...
    {
        public static (NDArray, NDArray, NDArray, NDArray) LoadMNIST()
        {
        ...
        public static (NDArray, NDArray) ShuffleData(NDArray images, NDArray labels)
        {
            int numSamples = images.shape[0];
            var indices = np.arange(numSamples);
